...
<body class="font-sans antialiased">
    <div class="flex">
        <div class="sticky top-0 sidebar bg-base-200">
            <header class="shadow-lg bg-base-100">
                <div class="image-text">
                    ...
                    <div class="text header-text">
                        <label class="name">Pink Store</label>
                    </div>
                </div>
            ...
            <div class=" sidebar-content">
                <nav id="test" class="fixed z-50 overflow-y-auto ">
                    <ul class="h-[85vh]">
                        <li><a class="" href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"
                                ...
                                </svg> <label for="">Dashboard</label> </a> </li>

                        <li class="">
                            <a class="active" href="#"> <svg xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 16 16" fill="currentColor" class="size-4">
                                    <path
                                        d="M8.543 2.232a.75.75 0 0 0-1.085 0l-5.25 5.5A.75.75 0 0 0 2.75 9H4v4a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-1a1 1 0 1 1 2 0v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V9h1.25a.75.75 0 0 0 .543-1.268l-5.25-5.5Z" />
                                </svg>
                                <label for="">Submenu</label> <span></span></a>

                            <ul class="submenu primary-content active">
                                <li><a class="active" href="#"><label for="">HTML & CSS</label></a></li>
                                <li><a href="#"><label for="">PHP</label></a></li>
                                <li><a href="#"><label for="">JQuery</label></a></li>
                            </ul>

                        </li>
                        <li>
                            <a id="click" href="#">Categorías <span></span></a>
                            <ul id="openMenu" class="submenu primary-content">
                                <li><a href="#">HTML y CSS</a></li>
                                <li><a href="#">PHP</a></li>
                                <li><a href="#">JQuery</a></li>
                            </ul>
                        </li>
                        <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"
                                    fill="currentColor" class="size-4">
                                    <path
                    ...
                    <div class="sticky bottom-0 px-2 flex flex-row items-center gap-2">
                        <label class="font-semibold text-xs">Theme Control:</label>
                        <input type="checkbox" value="nord" class="toggle theme-controller checkbox-sm" />
                    </div>
                </nav>
            </div>
        </div>
        <div class="w-full h-screen main-content ">
            <div class="sticky top-0 shadow-lg navbar bg-base-100">
            ...
            <div class="px-2 py-4 sm:px-6 lg:px-4">
                test
            </div>
        </div>
    </div>
