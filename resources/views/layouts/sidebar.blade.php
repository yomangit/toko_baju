<div class="fixed inset-y-0 sidebar hidden lg:block bg-base-200 shadow-md  w-[18%] z-10">
    <header class="shadow-lg relative align-items-center bg-base-100 h-[56px] ">
        <div id="avatar" class="absolute inset-0 flex items-center gap-2 px-2 py-1 avatar">
            ...
            <label id="text_avatar" class="text-[24px] bg-gradient-to-r from-pink-500 to-violet-500 bg-clip-text text-5xl font-extrabold text-transparent font-baskerville">Pink Store</label>
    ...
    <div class="h-[70vh] overflow-y-auto ">
        <ul class="w-full menu menu-md bg-base-200">
            ...
            <li>
                <a class="{{ Request::is('admin/CustomerController')?'menu-active':'' }}" href="{{ route('CustomerController') }}">
